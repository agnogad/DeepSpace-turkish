              ...
              PowerBlocks.apply {
                ...
                makePlanetContext(阿德里) {
                  val 初级科技 = research("初级科技", 180, 34) {
                    ...
                    localization { tr_TR { localizedName = "İlkel Teknoloji" } }
                  }
                  val 基础存储与物流 = research("基础存储与物流", 120) {
                    ...
                    localization { tr_TR { localizedName = "Temel Depolama ve Lojistik" } }
                  }
                  ...
                  val 进阶存储与物流 = research("进阶存储与物流", 120) {
                    ...
                    localization { tr_TR { localizedName = "Gelişmiş Depolama ve Lojistik" } }
                  }
                  ...
                  research("血肉与物流", 120) {
                    ...
                    localization { tr_TR { localizedName = "Et ve Lojistik" } }
                  }
                  ...
                  research("高阶存储与物流", 120) {
                    ...
                    localization { tr_TR { localizedName = "İleri Düzey Depolama ve Lojistik" } }
                  }
                  ...
                  research("基础物流管理模块", 120) {
                    ...
                    localization { tr_TR { localizedName = "Temel Lojistik Yönetim Modülü" } }
                  }
                  ...
                  val 初级能量设施 = research("初级能量设施", 120) {
                    ...
                    localization { tr_TR { localizedName = "Temel Enerji Tesisleri" } }
                  }
                  val 增益装置 = research("增益装置", 120) {
                    addDependency(初级能量设施)
                    addContent(小型照明器,大型照明器,定向超速器)
                  }.apply {
                    localization { tr_TR { localizedName = "Güçlendirme Cihazları" } }
                  }
                  ...
                  val 高级能量设施 = research("高级能量设施", 120) {
                    ...
                    localization { tr_TR { localizedName = "Gelişmiş Enerji Tesisleri" } }
                  }
                  val 这是你的神经吗 = research("这是你的神经吗", 120) {
                    addDependency(高级能量设施)
                    addContent(神经束节点,神经索节点)
                  }.apply {
                    localization { tr_TR { localizedName = "Bu Senin Sinirin mi" } }
                  }
                  val 裂与聚 = research("裂与聚", 120) {
                    addDependency(高级能量设施)
                    addContent(热核裂变反应堆,终归反应堆,核子冲击反应堆)
                  }.apply {
                    localization { tr_TR { localizedName = "Fisyon ve Füzyon" } }
                  }
                  ...
                  val 基础防御 = research("基础防护", 120) {
                    ...
                    localization { tr_TR { localizedName = "Temel Savunma" } }
                  }
                  val 中阶防护1 = research("中阶防护1", 120) {
                    addDependency(基础防御)
                    addContent(铱墙, 大型铱墙, 流金墙, 大型流金墙, 铬墙, 大型铬墙)
                  }.apply {
                    localization { tr_TR { localizedName = "Orta Kademe Koruma 1" } }
                  }
                  val 中阶防护2 = research("中阶防护2", 120) {
                    ...
                    localization { tr_TR { localizedName = "Orta Kademe Koruma 2" } }
                  }
                  ...
                  research("皮肉之苦", 120) {
                    ...
                    localization { tr_TR { localizedName = "Et ve Kemik Acısı" } }
                  }
                  ...
                  val 高阶防护1 = research("高阶防护1", 120) {
                    ...
                    localization { tr_TR { localizedName = "İleri Düzey Koruma 1" } }
                  }
                  ...
                  research("高阶防护2", 120) {
                    ...
                    localization { tr_TR { localizedName = "İleri Düzey Koruma 2" } }
                  }
                  ...
                  val 矿物加工1 = research("矿物加工1", 120) {
                    ...
                    localization { tr_TR { localizedName = "Mineral İşleme 1" } }
                  }
                  ...
                  research("矿物加工2", 120) {
                    ...
                    localization { tr_TR { localizedName = "Mineral İşleme 2" } }
                  }
                  ...
                  val 高阶合成工厂 = research("高阶合成工厂", 120) {
                    ...
                    localization { tr_TR { localizedName = "İleri Düzey Sentez Fabrikası" } }
                  }
                  ...
                  research("我们的工厂", 120) {
                    ...
                    localization { tr_TR { localizedName = "Bizim Fabrikamız" } }
                  }
                  ...
                  val 特化冶炼阵列 = research("特化冶炼阵列", 120) {
                    ...
                    localization { tr_TR { localizedName = "Özelleşmiş İzabe Dizisi" } }
                  }
                  ...
                  research("混合物制作器", 120) {
                    ...
                    localization { tr_TR { localizedName = "Karışım Üretici" } }
                  }
                  research("化合产物1", 120) {
                    addDependency(特化冶炼阵列)
                    addContent(电解机, 渗透分离槽, 反应仓, 燃烧室)
                  }.apply {
                    localization { tr_TR { localizedName = "Kimyasal Ürünler 1" } }
                  }
                  val 化合产物2 = research("化合产物2", 120) {
                    addDependency(特化冶炼阵列)
                    addContent(真空坩埚, 干馏塔, 蒸馏净化器, 渗透净化器, 热能冶炼炉)
                  }.apply {
                    localization { tr_TR { localizedName = "Kimyasal Ürünler 2" } }
                  }
                  ...
                  val 中子基础 = research("中子基础", 120) {
                    ...
                    localization { tr_TR { localizedName = "Nötron Temelleri" } }
                  }
                  ...
                  research("中子进阶", 120) {
                    ...
                    localization { tr_TR { localizedName = "Nötron İleri Seviye" } }
                  }
                  research("中子高阶", 120) {
                    addDependency(中子基础)
                    addContent(质量生成器, 物质逆化器, 强子重构仪, 析构器)
                  }.apply {
                    localization { tr_TR { localizedName = "Nötron İleri Düzey" } }
                  }
                  ...
                  val 资源生成1 = research("资源生成1", 120) {
                    ...
                    localization { tr_TR { localizedName = "Kaynak Üretimi 1" } }
                  }
                  research("牙齿", 120) {
                    addDependency(资源生成1)
                    addContent(血肉钻井)
                  }.apply {
                    localization { tr_TR { localizedName = "Dişler" } }
                  }
                  research("资源生成2", 120) {
                    addDependency(资源生成1)
                    addContent(热熔钻井, 潮汐钻头, 引力延展室)
                  }.apply {
                    localization { tr_TR { localizedName = "Kaynak Üretimi 2" } }
                  }
                  ...
                  research("光合作用", 120) {
                    ...
                    localization { tr_TR { localizedName = "Fotosentez" } }
                  }
                  ...
                  research("深层挖掘", 120) {
                    ...
                    localization { tr_TR { localizedName = "Derin Kazı" } }
                  }
